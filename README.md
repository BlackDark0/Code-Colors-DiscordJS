...
To **using colors on discord.js**, this is [a _typedef_ Colors](https://old.discordjs.dev/#/docs/discord.js/main/typedef/Colors), `Colors.Aqua` to get the Aqua color.
